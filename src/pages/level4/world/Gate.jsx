...
export default function Gate() {
    ...
    useFrame(() => {
        ...
        if ((-98 > avatar.avatarBodyRef?.translation().z) && (-1 < avatar.avatarBodyRef?.translation().x) && (avatar.avatarBodyRef?.translation().x < 1) && (!onGate)) {
            onGate = true;
            // alert('En porton');
    ...
    return (
        ...
        // >
            ...
            dispose={null}>
                <group scale={0.01}>
                    <group position={[0, 0, -9950]} rotation={[-Math.PI / 2, 0, 0]} scale={100}>
                    <RigidBody
                    type='fixed'
                    // type='dynamic'
                    colliders='cuboid'
